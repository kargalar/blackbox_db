...
import 'package:blackbox_db/1_Core/Widgets/sure_dialog.dart';
...
class Helper {
  ...
  void getMessage({
    ...
    Get.snackbar(
      ...
      backgroundColor: status == StatusEnum.WARNING ? AppColors.red.withOpacity(0.9) : AppColors.panelBackground.withOpacity(0.9),
